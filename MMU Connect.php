	...
	<body style="overflow-x: scroll;">
		...
		<div data-role="page" id="home">
			...
			<div data-role="main" style="text-align: right;">
				...
				<a href="profile.php" class="ui-btn ui-btn-inline ui-corner-all">My Profile</button> 
			<?php
		...
		<div data-role="page" id="documents">
			...
			<div data-role="navbar">
				<ul>
					...
					<li><a href="#documents" class="ui-btn-active ui-state-persist">Documents</a></li>
					<li><a href="#calculator">CGPA Calculator</a></li>
					<li><a href="#event">Event Planner</a></li>
				</ul>
			</div>
			<div>
				...
				?>
				<a href="upload.php" class="ui-btn ui-btn-inline ui-corner-all" onclick="goToUpload();">Please add your document or file</a><br><br>
				<script type="text/javascript">function goToUpload() {window.location.href= 'upload.php';}</script>
				<?php
					while ($eRow = mysqli_fetch_array($res)){
						$test = "download.php?dow=".$eRow['path'];
						echo $eRow['id']." ".$eRow['name']." "."<a href=".$test.">Download</a><br>";
					}
				?>
			</div>
		</div>
